...
export default function CampanhasPage() {
  ...
  const [form, setForm] = useState({
    ...
    numeros: '' // textarea com números separados por linha
  })
              ...
              <div key={c.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-zinc-500 text-xs mt-0.5">
                      {c.total_contatos} contatos · intervalo {c.intervalo_min_seg}–{c.intervalo_max_seg}s
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-zinc-400 w-24 text-right">
                    {c.enviados}/{c.total_contatos} · {c.erros} erros
                  </span>
                </div>
              </div>
            )
